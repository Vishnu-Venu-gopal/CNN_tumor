...
image_dir = 'C:/Users/vishnu venugopal/Desktop/Deep Learning/tumordata'

# Create output directory if it doesn't exist
output_dir = r'C:\Users\vishnu venugopal\Desktop\Deep Learning\CNN\tumor_detection\results'
...
plt.savefig(os.path.join(output_dir, 'tumor_sample_accuracy_plot.png'))
...
plt.savefig(os.path.join(output_dir, 'tumor_sample_loss_plot.png'))
...
model_save_path = os.path.join(output_dir, 'model', 'cnn_tumor.keras')
...
make_prediction('C:/Users/vishnu venugopal/Desktop/Deep Learning/tumordata/yes/y6.jpg', model)
print("--------------------------------------\n")
make_prediction('C:/Users/vishnu venugopal/Desktop/Deep Learning/tumordata/no/no1.jpg', model)
print("--------------------------------------\n")
